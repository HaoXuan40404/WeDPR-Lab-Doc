...
htmlhelp_basename = 'WeDPR_en_doc'
...
latex_documents = [
  (master_doc, 'WeDPR_en.tex', u'WeDPR Documentation',
   u'wedpr-dev', 'manual'),
]
...
man_pages = [
    (master_doc, 'WeDPR-Lab-Doc', u'WeDPR-Lab-Doc Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'WeDPR-Lab', u'WeDPR-Lab Documentation',
   author, 'wedpr-dev', 'english documents of WeDPR-Lab',
   'Miscellaneous'),
]
